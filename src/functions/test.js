...
exports.handler = (event, context, callback) => {
  callback(null, {
    statusCode: 200,
    body: `TEST:: context: ${JSON.stringify(context)}, context1: ${JSON.stringify(context1)}, context2: ${JSON.stringify(context2)}, host: ${host}, clientId: ${clientId}, clientSecret: ${clientSecret}, password: ${password},`
  })
}